...
urlpatterns = [
    ...
    path('login', views.login), # route that logs the user in
    ...
    path('fav', views.fav), # route that adds a game to the users favorites
    path('unfav', views.unfav), # route that removes a game from the users favorites
    path('logout', views.logout), # route that logs the user out
	]